...
const Login = () => {
    ...
    return (
        <main className="w-full h-full flex flex-col lg:pe-40 justify-center py-5 px-4">
            <div className="max-w-sm w-full mx-auto text-gray-600 space-y-5">
                ...
                <p className="text-center">Don't have an account? <Link to='/signup' className="font-medium text-indigo-600 underline hover:text-indigo-500"> Create an account</Link></p>
            </div>
        </main>
    );
};
