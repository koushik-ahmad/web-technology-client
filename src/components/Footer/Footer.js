...
const Footer = () => {
    return (
        <footer class="bg-white dark:bg-gray-900">
            <div class="mx-auto w-full max-w-screen-2xl lg:px-10 p-4 py-6 lg:py-8">
                <div class="md:flex md:justify-between">
                    <div class="mb-6 md:mb-0">
                        <Link to='/' class="flex items-center">
                            <img src="https://i.ibb.co/2S83PPW/logo.png" class="h-12 mr-3" alt="FlowBite Logo" />
                            <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Web Technology</span>
                        </Link>
                    </div>
                ...
                <div class="lg:block md:block sm:flex sm:items-center sm:justify-between">
                    ...
                    <h2 class="pt-6 text-lg text-gray-900 sm:text-center dark:text-gray-400">© 2023 <Link to='/' class="hover:underline">Web Technology</Link>. All Rights Reserved.
                    </h2>
                </div>
            </div>
        </footer>
