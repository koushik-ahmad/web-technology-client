...
const Checkout = () => {
    ...
    const { id, name, photoURL, description } = checkout;
        ...
        <div className='p-5'>
            <div className="flex flex-col max-w-3xl p-6 space-y-4 sm:p-10 border shadow-lg rounded-md text-gray-800">
                <ul className="flex flex-col divide-y divide-gray-300">
                    <li className="flex flex-col pb-6 sm:flex-row sm:justify-between">
                        <div className="flex w-full space-x-2 sm:space-x-4">
                            <img className="flex-shrink-0 object-cover w-20 h-20 border-transparent rounded outline-none sm:w-32 sm:h-32 bg-gray-500" src={photoURL} alt="Polaroid camera" />
                ...
                <div className="flex justify-end space-x-4">
                    ...
                    <Link to=''>
                        <button onClick={() => window.my_modal_3.showModal()} type="button" className="px-6 py-2 border rounded-md bg-violet-600 text-gray-50 border-violet-600">
