                    ...
                    <ul className="justify-end items-center space-y-6 md:flex md:space-x-6 md:space-y-0">
                        ...
                        <div className='space-y-2 text-md items-center gap-x-6 md:flex md:space-y-0'>
                            ...
                            <li className=''>
                                ...
                                <Link className="hs-dark-mode-active:block hidden hs-dark-mode group flex items-center text-gray-600 hover:text-blue-600 font-medium dark:text-gray-400 dark:hover:text-gray-500" href="#!" data-hs-theme-click-value="light">
                                    <svg className="w-4 h-4" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
